...
export default function HomePage() {
    return (
    <main><h1>Wo Ideen ihre Reise machen – in der Welt der Codes.</h1>
    ...
    <section><div>Wo Ideen ihre Reise machen – in der Welt der Codes.</div>
    <div className="miscellaneous">Wo Ideen ihre Reise machen – in der Welt der Codes.</div>
    <div className="copyright">Wo Ideen ihre Reise machen – in der Welt der Codes.</div></section>
